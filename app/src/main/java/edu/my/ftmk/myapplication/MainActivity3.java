...
import edu.my.ftmk.myapplication.databinding.ActivityExpensesBinding;
...
public class MainActivity3 extends AppCompatActivity {
    ...
    private void fnInvokeDatePicker(){
        ...
        pickerDialog = new DatePickerDialog(MainActivity3.this, new DatePickerDialog.OnDateSetListener() {
            @Override
    ...
    {
        int qtyItem = (int) binding.spinner.getSelectedItem();
